<template>
  <div>
    ...
    <div class="operation">
      <el-button type="primary" plain @click="handleAdd" v-if="user.role === 'BUSINESS'"  >新增</el-button>
...
export default {
  ...
  created() {
    ...
    this.$request.get('/business/selectAll', { //get business which have pass the pending view
      params: {
        status: '通过'
      }
    }).then(res => {
